...
import { Calendar, BarChart3, Users, Menu, X, ClipboardList, LogOut, Building2, CalendarDays, FileBarChart2, ClipboardCheck, TrendingUp, LineChart } from 'lucide-react';
...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: LineChart,
      active: pathname === '/reportes/promedios-mensuales' || pathname.startsWith('/reportes/promedios-mensuales/'),
    },
  ];
